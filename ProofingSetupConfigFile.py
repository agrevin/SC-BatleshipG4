...
class LaunchProofSetup:
    def __init__(self):
        self.BattleGroundProofDirect = f'{os.getcwd()}/BattleGround_proof_v2'
        ...
        self.launch_proofing_setup(self.BattleGroundProofDirect,f'zokrates compile -i BattleGround_proof_v2.zok')
